...
import { Brain, TestTube, Code2, Database, TrendingUp, CheckCircle } from 'lucide-react';
...
const AdditionalProjects: React.FC = () => {
  ...
  return (
    <section id="additional-projects" className="section-padding bg-white pt-20 pb-20 md:pt-32 md:pb-32 relative overflow-hidden">
      <div className="container-desktop relative z-10">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Additional Projects & Contributions</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Exploring diverse technical areas and contributing to various aspects of software development beyond the main project scope
          </p>
        </div>
